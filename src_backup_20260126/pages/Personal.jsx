...
const Personal = () => {
    ...
    useEffect(() => {
        const savedUser = localStorage.getItem('todotejidos_user');
        if (savedUser) {
    ...
    return (
        <div className="p-6 max-w-4xl mx-auto pb-32">
            <header className="mb-10 flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-black uppercase text-slate-800 dark:text-white flex items-center gap-3">
                        <Clock className="text-blue-600" size={32} />
                        Mi Personal
                    </h1>
                    <p className="text-slate-500 font-bold text-xs uppercase tracking-widest mt-1">Gestión de Tiempo y Asistencia</p>
                </div>
            ...
            {['ADMIN', 'SUPERVISOR'].includes(user?.rol) && (
                <div className="mb-12">
                    <div className="bg-slate-900 rounded-[2.5rem] p-8 shadow-2xl shadow-slate-900/20 border border-slate-700">
                        <div className="flex items-center gap-3 mb-6">
                            <div className="p-3 bg-indigo-500 rounded-2xl text-white">
                                <CheckCircle size={24} />
                            </div>
                            <div>
                                <h2 className="text-2xl font-black text-white uppercase tracking-tighter">Panel de Gestión</h2>
                                <p className="text-slate-400 text-xs font-bold uppercase tracking-widest">Aprobar Solicitudes y Asistencia</p>
                            </div>
                        </div>
                        <PersonalAdmin />
                    </div>
            ...
            {/* RELOJ CONTROL */}
            <section className="bg-white dark:bg-[#1a202c] rounded-[2.5rem] p-8 shadow-xl mb-12 flex flex-col items-center justify-center text-center border-2 border-slate-100 dark:border-slate-800">
                <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <section className="bg-white dark:bg-[#1a202c] rounded-3xl p-6 shadow-sm border border-slate-100 dark:border-slate-800">
                ...
                <section className="bg-white dark:bg-[#1a202c] rounded-3xl p-6 shadow-sm border border-slate-100 dark:border-slate-800">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <button
                            ...
                            className="bg-slate-900 dark:bg-white text-white dark:text-slate-900 p-2 rounded-xl hover:scale-105 transition-all"
                        >
                        ...
                        <div className="bg-white dark:bg-[#1e2532] w-full max-w-md rounded-3xl p-8 shadow-2xl animate-in fade-in zoom-in-95">
                            ...
                            <form onSubmit={solicitarVale} className="space-y-4">
                                ...
                                <div className="flex gap-3 mt-8">
                                    ...
                                    <button
                                        type="submit"
                                        className="flex-1 bg-slate-900 text-white py-4 rounded-xl font-black uppercase text-xs hover:bg-slate-800 transition-all shadow-lg shadow-slate-900/20"
                                    >
                                        Enviar Solicitud
                                    </button>
                                </div>
