            ...
            <div className="grid grid-cols-1 gap-6">
                ...
                <div className="bg-[var(--bg-card)] rounded-[2rem] p-6 border border-[var(--border-ui)] shadow-sm">
                    <h3 className="font-black uppercase text-[var(--text-main)] mb-4 flex items-center gap-2">
                        <FileText size={18} className="text-[var(--brand)]" /> Solicitudes Pendientes
                        <button onClick={fetchData} className="ml-auto p-1.5 bg-[var(--bg-input)] hover:bg-[var(--border-ui)] text-[var(--text-muted)] rounded-lg transition-colors" title="Actualizar">
                            <RefreshCw size={14} />
                        </button>
                    </h3>
                                ...
                                {historialSolicitudes.map(h => (
                                    <tr key={h.id} className="text-[var(--text-main)]">
                                        ...
                                        <td className="py-3 text-right">
                                            {h.estado === 'APROBADO' && (
                                                <button onClick={() => generarPDF(h)} className="text-[var(--brand)] font-bold uppercase text-[9px] flex items-center gap-1 justify-end">
